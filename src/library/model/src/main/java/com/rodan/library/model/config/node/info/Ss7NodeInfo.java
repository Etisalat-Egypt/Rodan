...
public abstract class Ss7NodeInfo extends NodeInfo {
    private String pointCode;

    public Ss7NodeInfo(String nodeName, String address, String port, String pointCode) {
    ...
    public void validate() throws ValidationException {
        super.validate();
        Validator.validatePointCode(pointCode);
    }
}
