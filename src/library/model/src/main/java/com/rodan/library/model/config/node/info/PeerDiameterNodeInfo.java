...
public class PeerDiameterNodeInfo extends DiameterNodeInfo {
    private String localPortRange;
    private String attemptConnect;
    private List<String> realms;

    public PeerDiameterNodeInfo(String nodeName, String address, String port, DiameterAppInfo appInfo,
                                String localPortRange, String attemptConnect, List<String> realms) {
