...
public class SepAssociationInfo extends Ss7AssociationInfo<SepNodeInfo> {
    private StpNodeInfo peerNode;

    @Builder
    public SepAssociationInfo(String routingContext, String networkIndicator, SepNodeInfo localNode, StpNodeInfo peerNode) {
    ...
    public void validate() throws ValidationException {
        super.validate();
        Validator.validateMandatoryField(peerNode, "peerNode");
        peerNode.validate();
    }
}
