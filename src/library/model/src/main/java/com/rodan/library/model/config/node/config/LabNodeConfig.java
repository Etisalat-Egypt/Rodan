...
public class LabNodeConfig extends SepNodeConfig {
    @Builder
    public LabNodeConfig(SctpMode sctpMode, SepAssociationInfo associationInfo, TargetNetworkInfo targetNetworkInfo,
