...
package com.rodan.lab.ss7.hlr.main.cli;
...
import com.rodan.lab.ss7.hlr.usecases.simulation.infogathering.RoutingInfoSimulator;
...
public class Main {
    ...
    public static final List<Class<?>> SS7_SIMULATORS = Util.getAvailableModules("com.rodan.lab.ss7.hlr.usecases.simulation");

    private String configPath;
    @Setter @Getter private LabNodeConfig nodeConfig;
    ...
    private void loadAvailableOptions() throws ApplicationException {
        ...
        for (var simulatorClass : SS7_SIMULATORS) {
            ...
            SignalingModule simulator = switch (simulatorName) {
                case Ss7SimulatorConstants.ROUTING_INFO_SIM_NAME -> RoutingInfoSimulator.builder()
                ...
                case Ss7SimulatorConstants.NEW_AUTH_VECTOR_SIM_NAME -> NewAuthVectorSimulator.builder()
                        ...
                        .gateway(ss7Gateway)
                        .build();
                case Ss7SimulatorConstants.LOCATION_ATI_SIM_NAME -> LocationAtiSimulator.builder()
                        .moduleOptions(moduleOps)
                        .gateway(ss7Gateway)
                        .build();
                case Ss7SimulatorConstants.UL_RESPONDER_NAME -> UlResponderSimulator.builder()
                        .moduleOptions(moduleOps)
                        .gateway(ss7Gateway)
                        .build();
    ...
    public void start() throws ApplicationException {
        try {
            logger.info("Starting HLR...");
            System.out.println("Starting HLR...");
            appStartAction();
            ...
            logger.info("HLR is ready!");
            System.out.println("HLR is ready!");
