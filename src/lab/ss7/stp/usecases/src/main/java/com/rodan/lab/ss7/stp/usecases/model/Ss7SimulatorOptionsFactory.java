...
package com.rodan.lab.ss7.stp.usecases.model;
 ...
 */
public class Ss7SimulatorOptionsFactory implements Ss7ModuleOptionsFactory<StpNodeConfig> {
    ...
    @Override
    public Ss7ModuleOptions create(String moduleName, StpNodeConfig nodeConfig) throws ValidationException {
        var targetNetworkInfo = nodeConfig.getTargetNetwork();


        Ss7ModuleOptions options = switch (moduleName) {
            // Information Gathering
            case Ss7SimulatorConstants.STP_SIM_NAME -> StpSimulatorOptions.builder()
