...
@Payload(name = Constants.CL_PAYLOAD_NAME)
@ToString(callSuper = true)
public class CLPayloadWrapper extends JSs7PayloadWrapper<MapMobilityService, MAPDialogMobility> {
    ...
    public MAPDialogMobility generateCarrier() throws SystemException {
        ...
        var callingStr = "Yes".equalsIgnoreCase(getSpoofHlr()) ?
                getTargetHlrGt() : getLocalGt();
    ...
    protected MAPApplicationContext getApplicationContext() throws SystemException {
        ...
        return MAPApplicationContext.getInstance(MAPApplicationContextName.locationCancellationContext, mapContextVersion);
    }
}
