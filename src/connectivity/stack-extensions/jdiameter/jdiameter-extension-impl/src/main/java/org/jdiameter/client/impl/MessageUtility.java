...
public class MessageUtility {
  ...
  // ########### TRX: PATCH START
  public static void addOriginAvps(Message m, String realm, String host) {
    // FIXME: check for "userFqnAsUri" ?
    AvpSet set = m.getAvps();
    if (set.getAvp(Avp.ORIGIN_HOST) == null) {
      m.getAvps().addAvp(Avp.ORIGIN_HOST, host, true, false, true);
    }
    if (set.getAvp(Avp.ORIGIN_REALM) == null) {
      m.getAvps().addAvp(Avp.ORIGIN_REALM, realm, true, false, true);
    }
  }
  // ########### TRX: PATCH END
