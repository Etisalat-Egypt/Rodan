...
public class ClrPayload extends DiameterPayload {
    private String imsi;
    private String targetMmeHost;

    @Builder
    public ClrPayload(String destinationRealm, String destinationHost, String originRealm, String originHost,
                      String imsi, String targetMmeHost) {
    ...
    public String getPayloadName() {
        return Constants.CLR_PAYLOAD_NAME;
    }
}
