...
public class AuthenticationInformationAnswerImpl extends DiameterMessageImpl implements AuthenticationInformationAnswer {
    ...
    private List<AuthVector> authVectors;

    @Builder
    public AuthenticationInformationAnswerImpl(ResultCode resultCode, String sessionId, String originHost,
                                               List<AuthVector> authVectors) {
        super(resultCode, sessionId);
        this.originHost = originHost;
        this.authVectors = authVectors;
    }
    ...
    @Override
    public List<AuthVector> getAuthVectors() {
        return authVectors;
    }
}
