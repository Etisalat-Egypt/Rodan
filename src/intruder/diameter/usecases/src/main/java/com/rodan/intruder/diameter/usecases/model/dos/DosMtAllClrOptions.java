...
@Getter @ToString
public class DosMtAllClrOptions extends DiameterModuleOptions {
    ...
    @Builder
    public DosMtAllClrOptions(IntruderNodeConfig nodeConfig, String imsi, String targetMme, String destinationRealm) {
        super(nodeConfig);
