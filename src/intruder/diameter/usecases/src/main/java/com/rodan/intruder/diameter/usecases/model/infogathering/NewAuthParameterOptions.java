...
@Getter @ToString
public class NewAuthParameterOptions extends DiameterModuleOptions {
    ...
    @Builder
    public NewAuthParameterOptions(IntruderNodeConfig nodeConfig, String imsi, String destinationRealm, String spoofOrigin,
                                   String spoofedHost, String spoofedRealm, String mcc, String mnc) {
        super(nodeConfig);
