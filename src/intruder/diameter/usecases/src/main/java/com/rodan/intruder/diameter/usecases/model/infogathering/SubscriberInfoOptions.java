...
@Getter @ToString
public class SubscriberInfoOptions extends DiameterModuleOptions {
    ...
    @Builder
    public SubscriberInfoOptions(IntruderNodeConfig nodeConfig, String imsi, String destinationRealm, String mcc, String mnc) {
        super(nodeConfig);
