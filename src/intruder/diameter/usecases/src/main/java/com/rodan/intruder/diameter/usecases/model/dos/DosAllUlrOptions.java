...
@Getter @ToString
public class DosAllUlrOptions extends DiameterModuleOptions {
    @Option(name = "imsi", description = "Target IMSI (either MSISDN or IMSI is required)", mandatory = true)
    private String imsi;

    @Option(name = "duration", description = "DoS duration in minutes (1 to 60)", mandatory = true)
    private String dosDuration;

    @Option(name = "delay", description = "Delay in milli seconds")
    ...
    @Builder
    public DosAllUlrOptions(IntruderNodeConfig nodeConfig, String imsi, String dosDuration, String delayMillis,
                            String destinationRealm, String mcc, String mnc) {
        super(nodeConfig);
        this.imsi = Objects.requireNonNullElse(imsi, "");
        this.dosDuration = Objects.requireNonNullElse(dosDuration, "5");
        this.delayMillis = Objects.requireNonNullElse(delayMillis, "1000");
    ...
    public void validate() throws ValidationException {
        ...
        Validator.validateDosDuration(dosDuration);
