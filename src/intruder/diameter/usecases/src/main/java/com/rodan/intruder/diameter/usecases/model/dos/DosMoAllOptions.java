...
@Getter @ToString
public class DosMoAllOptions extends DiameterModuleOptions {
    ...
    @Builder
    public DosMoAllOptions(IntruderNodeConfig nodeConfig, String imsi, String targetMme, String destinationRealm) {
        super(nodeConfig);
