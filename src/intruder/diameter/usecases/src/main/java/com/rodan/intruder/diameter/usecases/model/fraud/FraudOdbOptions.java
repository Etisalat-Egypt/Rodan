...
@Getter @ToString
public class FraudOdbOptions extends DiameterModuleOptions {
    ...
    @Builder
    public FraudOdbOptions(IntruderNodeConfig nodeConfig, String imsi, String targetMme, String destinationRealm) {
        super(nodeConfig);
