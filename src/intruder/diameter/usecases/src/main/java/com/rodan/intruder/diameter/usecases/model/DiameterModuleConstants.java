...
public interface DiameterModuleConstants {
    ...
    String SUBSCRIBER_INFO_BRIEF = "Disclose subscriber's information/profile";
    ...
    String NEW_AUTH_PARAM_BRIEF = "Disclose subscriber's new authentication parameters";
    ...
    String HSS_ADDRESS_AIR_BRIEF = "Disclose HSS address";
    ...
    String MME_IDR_BF_BRIEF = "Disclose subscriber's MME address ";
    ...
    String LOCATION_IDR_BRIEF = "Disclose subscriber's approximate location";
    ...
    String DOS_ALL_ULR_BRIEF = "Interrupt subscriber's availability (ULR)";
    ...
    String DOS_MT_SMS_BRIEF = "Interrupt subscriber's SMS availability";
    ...
    String DOS_MO_ALL_BRIEF = "Interrupt subscriber's availability (ODB)";
    ...
    String DOS_MO_ALL_RAT_BRIEF = "Interrupt subscriber's availability (Access Restriction)";
    ...
    String DOS_MT_ALL_BRIEF = "Interrupt subscriber's availability (PUR)";
    ...
    String DOS_MT_ALL_CLR_BRIEF = "Interrupt subscriber's availability (CLR)";
    ...
    String FRAUD_ODB_BRIEF = "Remove Operator Determined Barring";
    ...
    String FRAUD_ACCESS_RESTRICTION_BRIEF = "Remove operator's access restriction using";
