...
package com.rodan.intruder.diameter.usecases.model.fraud;
...
@Getter @ToString
public class FraudAccessRestrictionOptions extends DiameterModuleOptions {
    ...
    @Builder
    public FraudAccessRestrictionOptions(IntruderNodeConfig nodeConfig, String imsi, String targetMme, String destinationRealm) {
        super(nodeConfig);
