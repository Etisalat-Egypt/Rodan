...
@Getter @ToString
public class DosMoAllRatOptions extends DiameterModuleOptions {
    ...
    @Builder
    public DosMoAllRatOptions(IntruderNodeConfig nodeConfig, String imsi, String targetMme, String destinationRealm) {
        super(nodeConfig);
