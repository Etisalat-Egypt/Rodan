...
@Getter @ToString
public class MoCallInterceptionOptions extends Ss7ModuleOptions<IntruderNodeConfig> {
    @Option(name = "imsi", description = "Target IMSI", mandatory = true)
    private String imsi;

    @Option(name = "fmsisdn", description = "Forward MSISDN", mandatory = true)
    private String forwardMsisdn;

    @Option(name = "gsmscf", description = "Attacker gsmSCF address (empty means use local GT)")
    ...
    @Builder
    public MoCallInterceptionOptions(IntruderNodeConfig nodeConfig, String imsi, String forwardMsisdn, String gsmScf, String targetVlrGt,
                                     String targetHlrGt, String spoofHlr, String mapVersion) {
        super(nodeConfig);
        this.imsi = Objects.requireNonNullElse(imsi, "");
        this.forwardMsisdn = Objects.requireNonNullElse(forwardMsisdn, "");
        this.gsmScf = Objects.requireNonNullElse(gsmScf, "");
