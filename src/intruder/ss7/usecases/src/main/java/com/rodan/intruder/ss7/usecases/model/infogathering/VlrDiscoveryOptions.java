 ...
 */
@Getter @ToString
public class VlrDiscoveryOptions extends Ss7ModuleOptions<IntruderNodeConfig> {
    final static Logger logger = LogManager.getLogger(VlrDiscoveryOptions.class);
    ...
    @Builder
    public VlrDiscoveryOptions(IntruderNodeConfig nodeConfig, String targetVlrRange, String delayMillis, String mcc,
                               String mnc, String abuseOpcodeTag, String mapVersion) {
        super(nodeConfig);
