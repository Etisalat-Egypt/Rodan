...
@Getter @ToString
public class RoutingInfoOptions extends Ss7ModuleOptions<IntruderNodeConfig> {
    ...
    @Builder
    public RoutingInfoOptions(IntruderNodeConfig nodeConfig, String msisdn, String targetHlrGt, String mapVersion) {
        super(nodeConfig);
