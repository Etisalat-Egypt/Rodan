...
@Getter @ToString
public class DosPurgeOptions extends Ss7ModuleOptions<IntruderNodeConfig> {
    ...
    @Option(name = "vlr", description = "Target VLR global title")
    private String targetVlrGt;

    @Option(name = "spoof", description = "Spoof VLR address in SCCP CgPA (yes/no)", mandatory = true)
    private String spoofVlr;

    @Option(name = "acv", description = "MAP app context version (2, 3)", mandatory = true)
    private String mapVersion;

    @Builder
    public DosPurgeOptions(IntruderNodeConfig nodeConfig, String imsi, String msisdn, String targetVlrGt, String targetHlrGt,
                           String spoofVlr, String mapVersion) {
        super(nodeConfig);
        ...
        this.spoofVlr = Objects.requireNonNullElse(spoofVlr, "No");
    ...
    public void validate() throws ValidationException {
        ...
        Validator.validateToggleOption(spoofVlr, "spoofVlr");
        ...
        if ("Yes".equalsIgnoreCase(spoofVlr))
