...
@Getter @ToString
public class CamelInfoOptions extends Ss7ModuleOptions<IntruderNodeConfig> {
    ...
    @Builder
    public CamelInfoOptions(IntruderNodeConfig nodeConfig, String imsi, String mcc, String mnc, String cc,
                            String ndc, String mapVersion) {
        super(nodeConfig);
