...
public interface Ss7ModuleConstants {
    ...
    String ROUTING_INFO_BRIEF = "Disclose IMSI, HLR, and VLR using (SRI) message";
    ...
    String SMS_ROUTING_INFO_BRIEF = "Disclose IMSI, HLR, and vMSC using (SRI-SM) message";
    ...
    String LCS_ROUTING_INFO_BRIEF = "Disclose IMSI, VMSC and SGSN using (SRI-LCS) message";
    ...
    String GPRS_ROUTING_INFO_BRIEF = "Disclose GGSN & SGSN using (SRI-GPRS) message";
    ...
    String SEND_IMSI_BRIEF = "Disclose IMSI using Send-IMSI message";
    ...
    String NEW_AUTH_VECTOR_BRIEF = "Disclose authentication vectors using (SAI) message";
    String NEW_AUTH_VECTOR_DESCRIPTION = "Disclose subscriber authentication triplets using MAP Send-Authentication-Info (SAI) message. \nCan be used along with a fake BTS to intercept subscriber traffic.";
    ...
    String CURRENT_AUTH_VECTOR_BRIEF = "Disclose current authentication vectors using Send-Identification message";
    ...
    String HLR_ADDRESS_SM_BRIEF = "Disclose HLR address using Report-SM-Delivery-Status message";
    ...
    String CAMEL_INFO_BRIEF = "Disclose gsmSCF address using (UL) message";
    ...
    String VLR_BF_BRIEF = "Brute force VLR address using (PSI) message";
    ...
    String LOCATION_ATI_BRIEF = "Disclose location using (ATI) message";
    ...
    String LOCATION_PSI_BRIEF = "Disclose location using (PSI) message";
    ...
    String LOCATION_PSL_BRIEF = "Disclose location using (PSL) message";
    ...
    String SMS_INTERCEPTION_BRIEF = "Intercept SMS using (UL) message";
    ...
    String MO_CALL_INTERCEPTION_BRIEF = "Redirect outgoing calls using CAMEL IDP/Connect message";
    ...
    String MO_CALL_INTERCEPTION_MSRN_BRIEF = "Redirect incoming calls using PRN message";
    ...
    String SMS_FRAUD_BRIEF = "Send fraud SMS to subscriber";
    ...
    String DOS_CL_BRIEF = "Interrupt subscriber availability using (CL) message";
    ...
    String DOS_DSD_BRIEF = "Interrupt subscriber availability using (DSD) message";
    ...
    String DOS_PURGE_BRIEF = "Interrupt subscriber availability using Purge-MS message";
    ...
    String DOS_CALL_BARRING_BRIEF = "Interrupt subscriber availability 'MO calls and SMSs' using (ISD) message";
