...
@Getter @ToString
public class HlrAddressSmOptions extends Ss7ModuleOptions<IntruderNodeConfig> {
    @Option(name = "msisdn", description = "Target MSISDN", mandatory = true)
    private String msisdn;

    @Option(name = "smsc", description = "Attacker SMSC global title (empty means use local GT)")
    ...
    @Builder
    public HlrAddressSmOptions(IntruderNodeConfig nodeConfig, String msisdn, String smscGt, String mapVersion) {
        super(nodeConfig);
