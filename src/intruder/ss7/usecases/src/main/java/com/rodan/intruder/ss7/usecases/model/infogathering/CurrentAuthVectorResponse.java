...
@Getter @ToString
public class CurrentAuthVectorResponse extends ModuleResponse {
    private String imsi;
    ...
    @Builder
    public CurrentAuthVectorResponse(String imsi, List<AuthTriplet> tripletList, List<AuthQuintuplet> quintupletList,
