...
@Getter @ToString
public class DosDsdOptions extends Ss7ModuleOptions<IntruderNodeConfig> {
    ...
    @Builder
    public DosDsdOptions(IntruderNodeConfig nodeConfig, String imsi, String targetVlrGt, String targetHlrGt, String spoofHlr, String mapVersion) {
        super(nodeConfig);
    ...
    public void validate() throws ValidationException {
        ...
        if (StringUtils.isNotBlank(targetHlrGt)) {
