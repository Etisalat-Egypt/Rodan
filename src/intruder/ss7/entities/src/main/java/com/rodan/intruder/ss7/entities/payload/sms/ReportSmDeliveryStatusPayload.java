...
public class ReportSmDeliveryStatusPayload extends Ss7Payload {
    ...
    @Builder
    public ReportSmDeliveryStatusPayload(String localGt, String msisdn, String targetHlrGt, String smscGt,
                                         String mapVersion) {
    ...
    public String getPayloadName() {
        return Constants.REPORT_SM_DELIVERY_STATUS_PAYLOAD_NAME;
    }
}
