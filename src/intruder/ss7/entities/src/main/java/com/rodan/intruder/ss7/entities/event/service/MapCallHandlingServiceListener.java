...
public interface MapCallHandlingServiceListener extends MapServiceListener {
    Logger logger = LogManager.getLogger(MapMobilityServiceListener.class);

    default void onSendRoutingInformationRequest(SriRequest request) {
        logger.debug("[[[[[[[[[[    onSendRoutingInformationRequest      ]]]]]]]]]]");
        logger.debug(request);
    }

    default void onSendRoutingInformationResponse(SriResponse response) {
        logger.debug("[[[[[[[[[[    onSendRoutingInformationResponse      ]]]]]]]]]]");
        logger.debug(response);
    }

    default void onProvideRoamingNumberRequest(PrnRequest request) {
