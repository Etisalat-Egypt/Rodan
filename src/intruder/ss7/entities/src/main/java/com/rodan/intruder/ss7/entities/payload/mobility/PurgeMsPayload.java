...
public class PurgeMsPayload extends Ss7Payload {
    private String imsi;
    ...
    @Builder
    public PurgeMsPayload(String localGt, String imsi, String msisdn, String targetHlrGt,
                          String spoofVlr, String targetVlrGt, String mapVersion) {
    ...
    public String getPayloadName() {
        return Constants.PURGE_MS_PAYLOAD_NAME;
    }
}
