...
public class PsiPayload extends Ss7Payload {
    private String imsi;
    ...
    @Builder
    public PsiPayload(String localGt, String imsi, String targetVlrGt, String abuseOpcodeTag, String mapVersion) {
    ...
    public String getPayloadName() {
        return Constants.PSI_PAYLOAD_NAME;
    }
}
