...
public class AtiPayload extends Ss7Payload {
    ...
    @Builder
    public AtiPayload(String localGt, String msisdn, String imsi, String targetHlrGt,
                      String gsmSCFGt, String abuseOpcodeTag, String malformedAcn, String mapVersion) {
        super(localGt, Constants.SCCP_GSMSCF_SSN, Constants.SCCP_HLR_SSN);
        this.msisdn = msisdn;
        this.imsi = imsi;
    ...
    public String getPayloadName() {
        return Constants.ATI_PAYLOAD_NAME;
    }
}
