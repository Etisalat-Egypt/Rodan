...
public class SaiPayload extends Ss7Payload {
    private String imsi;
    ...
    @Builder
    public SaiPayload(String localGt, String imsi, String msisdn, String targetHlrGt,
    ...
    public String getPayloadName() {
        return Constants.SAI_PAYLOAD_NAME;
    }
}
