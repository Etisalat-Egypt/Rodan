...
public class DsdPayload extends Ss7Payload {
    private String imsi;
    ...
    @Builder
    public DsdPayload(String localGt, String imsi, String targetVlrGt, String spoofHlr,
    ...
    public String getPayloadName() {
        return Constants.DSD_PAYLOAD_NAME;
    }
}
