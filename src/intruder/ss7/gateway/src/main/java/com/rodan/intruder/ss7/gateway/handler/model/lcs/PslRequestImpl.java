...
public class PslRequestImpl extends PslRequest {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public PslRequestImpl(String imsi, String msisdn, String mlcNumber, MAPDialog mapDialog, long invokeId) {
        super(imsi, msisdn, mlcNumber);
