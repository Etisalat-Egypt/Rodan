...
public class RejectComponentImpl extends RejectComponent {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public RejectComponentImpl(MapProblem problem, boolean isLocalOriginated, MAPDialog mapDialog, long invokeId) {
        super(problem, isLocalOriginated);
