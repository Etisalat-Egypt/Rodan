...
public class ReportSmDeliveryStatusResponseImpl extends ReportSmDeliveryStatusResponse {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public ReportSmDeliveryStatusResponseImpl(String hlrGt, MAPDialog mapDialog, long invokeId) {
        super(hlrGt);
