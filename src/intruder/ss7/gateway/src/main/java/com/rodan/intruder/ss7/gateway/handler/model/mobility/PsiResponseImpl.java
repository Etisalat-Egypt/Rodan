...
public class PsiResponseImpl extends PsiResponse {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public PsiResponseImpl(SubscriberInfo subscriberInfo, LocationInfo locationInfo, String vlrGt, String sgsnGt,
                           MAPDialog mapDialog, long invokeId) {
        super(subscriberInfo, locationInfo, vlrGt, sgsnGt);
