...
public class SaiResponseImpl extends SaiResponse {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public SaiResponseImpl(List<AuthTriplet> tripletList, List<AuthQuintuplet> quintupletList,
                           List<EpcAuthVector> epcAuthVectorList, MAPDialog mapDialog, long invokeId) {
        super(tripletList, quintupletList, epcAuthVectorList);
