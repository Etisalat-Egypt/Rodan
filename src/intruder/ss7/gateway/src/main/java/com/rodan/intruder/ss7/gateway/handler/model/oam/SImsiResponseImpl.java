...
package com.rodan.intruder.ss7.gateway.handler.model.oam;
...
public class SImsiResponseImpl extends SImsiResponse {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public SImsiResponseImpl(String imsi, MAPDialog mapDialog, long invokeId) {
        super(imsi);
