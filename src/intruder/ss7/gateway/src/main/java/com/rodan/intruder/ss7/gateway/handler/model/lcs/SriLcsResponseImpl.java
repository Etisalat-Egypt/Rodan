...
package com.rodan.intruder.ss7.gateway.handler.model.lcs;
...
public class SriLcsResponseImpl extends SriLcsResponse {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public SriLcsResponseImpl(String msisdn, String imsi, String lmsi, String sMscNumber, String sGsnNumber,
                              MAPDialog mapDialog, long invokeId) {
        super(msisdn, imsi, lmsi, sMscNumber, sGsnNumber);
