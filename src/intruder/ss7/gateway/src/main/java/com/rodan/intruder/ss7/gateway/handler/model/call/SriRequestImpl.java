...
public class SriRequestImpl extends SriRequest {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public SriRequestImpl(String msisdn, String gmscOrGsmScfAddress, MAPDialog mapDialog, long invokeId) {
        super(msisdn, gmscOrGsmScfAddress);
