...
public class SendIdResponseImpl extends SendIdResponse {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public SendIdResponseImpl(String imsi, List<AuthTriplet> tripletList, List<AuthQuintuplet> quintupletList,
                              SecurityContext securityContext, MAPDialog mapDialog, long invokeId) {
        super(imsi, tripletList, quintupletList, securityContext);
