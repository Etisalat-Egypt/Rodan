...
package com.rodan.intruder.ss7.gateway.handler.model.call;
...
public class SriResponseImpl extends SriResponse {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public SriResponseImpl(String imsi, String hlrGt, String vmscGt, String vlrGt, String msrn1, String msrn2,
                           MAPDialog mapDialog, long invokeId) {
        super(imsi, hlrGt, vmscGt, vlrGt, msrn1, msrn2);
