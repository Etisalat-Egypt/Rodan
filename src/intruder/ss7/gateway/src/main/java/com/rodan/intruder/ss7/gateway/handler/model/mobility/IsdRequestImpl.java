...
public class IsdRequestImpl extends IsdRequest {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;
    private InsertSubscriberDataRequest originalRequest;

    @Builder
    public IsdRequestImpl(String msisdn, String hlrGt, String sgsn, String gsmScf, MAPDialog mapDialog, long invokeId,
                          InsertSubscriberDataRequest originalRequest) {
        super(msisdn, hlrGt, sgsn, gsmScf);
