...
public class DialogProviderAbortImpl extends DialogProviderAbort {
    private Ss7MapDialogImpl ss7Dialog;
    private long invokeId;

    @Builder
    public DialogProviderAbortImpl(MapAbortProviderReason abortReason, MapAbortSource abortSource, MAPDialog mapDialog, long invokeId) {
        super(abortReason, abortSource);
